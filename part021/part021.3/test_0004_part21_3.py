...
@allure.story('21.3.2:Тестирование функционала балансировки IGP: OSPF трафика между интерфейсами')
@allure.title('Проверка балансировки IGP: OSPF трафика между интерфейсами')
...
def test_ECMP_L3VPN_balance_21_3(DUT, ip_iperf_server, vrf_cli, vrf_cli2):
