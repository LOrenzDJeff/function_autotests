...
@allure.story('21.3.3:Тестирование функционала балансировки L3VPN IGP: OSPF трафика между интерфейсами методом лестница')
@allure.title('Проверка балансировки L3VPN IGP: OSPF трафика между интерфейсами с отключением интерфейсов')
...
def test_ECMP_L3VPN_upstair_21_3(DUT, ip_iperf_server, vrf_cli, vrf_cli2):
